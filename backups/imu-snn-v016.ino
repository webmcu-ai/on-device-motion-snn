...
const int   ANN_CONFIRM_WINDOWS = 1; // default 2;     // ANN: same answer this many 1-second windows in a row
...
void setup(){
  ...
  delay(1000);
  Serial.println("\n=== XIAO ESP32-S3 Motion ML - Streaming SNN air-writing (imu-snn-v016) ===");
