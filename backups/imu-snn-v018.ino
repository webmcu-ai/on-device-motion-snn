...
//   The ANN path keeps the old rule (same letter needs a different class between).
//
// WHAT'S NEW IN v016
...
//             The ANN still needs a different class in between.
...
void myUpdateOutputStringAnn(int finalPred){
  ...
  myCommitClass(gAnnPendingClass, false);
}
...
void setup(){
  ...
  delay(1000);
  Serial.println("\n=== XIAO ESP32-S3 Motion ML - Streaming SNN air-writing (imu-snn-v017) ===");
